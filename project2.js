...
var transZ = -5.0, rotX = 0, rotY = 0, autorot = 0, lightX = 1.0, lightY = 1.0;
...
function updateLightPos() {
    const translationSpeed = 0.3;
    if (keys['ArrowUp'] || keys['ArrowDown'] || keys['ArrowRight'] || keys['ArrowLeft']) {
        lightY += keys['ArrowUp'] ? translationSpeed : keys['ArrowDown'] ? -translationSpeed : 0;
        lightX += keys['ArrowRight'] ? translationSpeed : keys['ArrowLeft'] ? -translationSpeed : 0;
        DrawScene();
    }
}
